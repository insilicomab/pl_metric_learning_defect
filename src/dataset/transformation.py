        ...
        self.data_transform = {
            "train": transforms.Compose(
                [
                    transforms.Resize(
                        (
                            config.train_transform.resize.image_size,
                            config.train_transform.resize.image_size,
                        )
                    )
                    ...
                    transforms.RandomHorizontalFlip(
                        p=config.train_transform.random_horizontal_flip.p
                    )
                    if config.train_transform.random_horizontal_flip.enable
                    else NoneTransform(),
                    transforms.RandomVerticalFlip(
                        p=config.train_transform.random_vertical_flip.p
                    )
                    if config.train_transform.random_vertical_flip.enable
                    else NoneTransform(),
                    transforms.RandomRotation(
                        degrees=config.train_transform.random_rotation.degrees
                    )
            ...
            "val": transforms.Compose(
                [
                    transforms.Resize(
                        (
                            config.test_transform.resize.image_size,
                            config.test_transform.resize.image_size,
                        )
                    )
